...
def _valid_turn(number: int = 1) -> dict:
    ...
    turn = {
        ...
        "speech_end_to_client_delivery_ms": 400.0,
        "speech_end_to_request_ms": 10.0,
        "remote_request_start_monotonic_ms": 2010.0,
        "remote_response_monotonic_ms": 2200.0,
        "remote_request_latency_ms": 190.0,
...
def test_acceptance_requires_resources_reconnect_and_all_ten_turns() -> None:
    ...
    evidence = {
        ...
        "reconnect": {
            ...
            "backend_cleanup_observed": True,
            "redis_cleanup_observed": True,
            "initial_session_id": "old-session",
            "new_session_id": "new-session",
            "post_reconnect_remote_http_status": 200,
            "post_reconnect_final_delivered": True,
        },
        "preflight_pass": True,
        "rotated_remote_credential_configured": True,
        "tracked_secret_scan_pass": True,
        "mandatory_evidence_files": True,
        "redis_session_cleanup_pass": True,
    }
